...
namespace NS_Controller
{
  ...
  ControllerApplication::ControllerApplication ()
  {
    ...
    odom_srv = new NS_Service::Server<NS_ServiceType::ServiceOdometry> ("BASE_ODOM", boost::bind(&ControllerApplication::odomService, this, _1));
    odom_tf_srv = new NS_Service::Server<NS_ServiceType::ServiceTransform> ("BASE_ODOM_TF", boost::bind(&ControllerApplication::odomTransformService, this, _1));

    twist_sub = new NS_DataSet::Subscriber<NS_DataType::Twist> ("TWIST", boost::bind(&ControllerApplication::velocityCallback, this, _1));
  ...
  ControllerApplication::estimate ()
  {
    ...
    NS_Transform::Transform imu_measure;NS_DataSet::Subscriber<NS_DataType::Twist>* twist_sub;
  ...
  void
  ControllerApplication::odomService (NS_ServiceType::ServiceOdometry& odometry)
  {
    boost::mutex::scoped_lock locker_ (base_lock);
  ...
  void
  ControllerApplication::odomTransformService (NS_ServiceType::ServiceTransform& transform)
  {
    boost::mutex::scoped_lock locker_ (base_lock);
  ...
  void
  ControllerApplication::velocityCallback (NS_DataType::Twist& twist)
  {
    boost::mutex::scoped_lock locker_ (base_lock);
