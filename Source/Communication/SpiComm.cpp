...
namespace NS_Controller
{
  ...
  bool SpiComm::transfer(unsigned char* tx_buf, unsigned char* rx_buf,
  ...
  bool SpiComm::getRegister(unsigned short address, int length,
                            unsigned char* bytes)
  {
    ...
    unsigned char req_buf[MAX_SPI_OFFSET + 16] =
      {0};
    int req_buf_len = 0;
    ...
    unsigned char rep_buf[MAX_SPI_OFFSET + 16] =
      {0};
  ...
  bool SpiComm::setRegister(unsigned short address, unsigned char* bytes,
                            int length)
  {
    CntlSpiRequestType request;
    CntlSpiResponseType response;
