...
#define SPI_RESULT_FAILURE 0x00
  ...
  enum
  {
	...
	BASE_REG_ACTION = 0x128,
	BASE_REG_MASTER_X = 0x12C,
	BASE_REG_MASTER_Y = 0x130,
	BASE_REG_MASTER_THETA = 0x134,
	BASE_REG_MASTER_SYNC = 0x138,
	BASE_REG_EVENT = 0x13C,
	BASE_REG_MS_MODE = 0x140,
